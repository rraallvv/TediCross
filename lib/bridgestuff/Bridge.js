...
class Bridge {
	...
	constructor(settings) {
		...
		/**
		 * Whether to log messages for this bridge
		 *
		 * @type {Boolean}
		 */
	...
	/**
	 * Store the last user ID and set showUsername to true if it has changed
	 *
	 * @type {(String|Number)}
	 */
	set lastUserId(id) {
	...
	/**
	 * Store whether to show the last user name
	 *
	 * @type {Boolean}
	 */
	...
	/**
	 * Whether to show the last user name
	 *
	 * @type {Boolean}
	 */
	get showUsername() {
